    ...
    return (
        <div className="overflow-x-hidden">
            ...
            <section className="pt-20 md:py-40 px-2 relative" data-aos="fade-up">
                <div className="absolute inset-0 -z-10"
                    style={{
                    backgroundImage: "linear-gradient(to bottom, rgba(255, 255, 255, 0), rgba(255, 255, 255, 1)), url('../src/assets/img/ornamen/teksture 1.png')",
                    }}>
                </div>
            ...
            <section className="py-16 md:pt-20 relative" id="divisi">
                <div className="p-2 w-konten mx-auto" data-aos="fade-up">
                    ...
                    <div className="flex justify-center items-center flex-wrap md:w-3/4 mx-auto">
                        {divisiData.map((Data) =>(
                    ...
                    <div className="lg:flex lg:justify-between items-center" data-aos="zoom-in">
                        <div className="w-full lg:hidden block">
                            <div className="w-full my-5">
                                <img src="../src/assets/img/hero/bersama.JPG" className="w-full rounded-md" alt="Foto 1"></img>
                            </div>
                        </div>
